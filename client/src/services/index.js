...
export const financeService = {
  ...
  getStatistics: (params) =>
    apiClient.get("/finance/statistics", { params }),
...
export const notificationService = {
  ...
  markAsRead: (notificationIds) => apiClient.patch("/notifications/mark-read", { notificationIds }),
  markAllAsRead: () => apiClient.patch("/notifications/mark-read", { notificationIds: "all" }),
...
export const reportService = {
  ...
  // Retention Reports
  getRetentionStats: () =>
    apiClient.get("/director/reports/retention-stats"),
  getRetentionTrend: (params) =>
    apiClient.get("/director/reports/retention-trend", { params }),
  getDropoutReasons: () =>
    apiClient.get("/director/reports/dropout-reasons"),
