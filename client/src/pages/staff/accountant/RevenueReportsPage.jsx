    ...
    <div className="min-h-screen bg-gray-50/50 p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Phân tích hiệu quả kinh doanh theo thời gian thực</p>
          </div>
        </div>
      ...
      <Card className="border-gray-200 shadow-sm">
        <div className="flex flex-col md:flex-row items-end gap-4 p-1">
          ...
          <div className="w-full md:w-auto pb-0.5">
             <Button onClick={loadReport} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white">
                Áp dụng
             </Button>
          </div>
        </div>
        ...
        <Card className="lg:col-span-2 border-gray-200 shadow-sm">
          <div className="p-4 border-b border-gray-100 flex justify-between items-center">
             <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-gray-800">Biểu Đồ Phân Bố Doanh Thu</h3>
             </div>
          </div>
          <div className="p-4">
      ...
      <Card className="border-gray-200 shadow-sm overflow-hidden">
        <div className="p-5 border-b border-gray-100">
          <h3 className="font-bold text-gray-800">Chi Tiết Doanh Thu Theo Loại</h3>
          <p className="text-sm text-gray-500 mt-1">Phân tích chi tiết nguồn thu nhập</p>
        </div>
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-gray-50 text-gray-600 font-semibold uppercase tracking-wider">
              <tr>
                ...
                <th className="px-6 py-4 text-right rounded-tr-lg">Giá Trị Trung Bình</th>
              </tr>
            </thead>
            ...
            {reportData.summary.totalRevenue > 0 && (
                <tfoot className="bg-gray-50 font-bold text-gray-900 border-t border-gray-200">
                    <tr>
                        ...
                        <td className="px-6 py-4 text-right">{reportData.summary.receiptCount}</td>
                        <td className="px-6 py-4 text-right text-emerald-700">{formatCurrency(reportData.summary.totalRevenue)}</td>
