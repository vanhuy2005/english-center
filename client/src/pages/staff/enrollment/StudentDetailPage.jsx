                            ...
                            {enrollments.map((enrollment) => (
                              ...
                              >
                                ...
                                <td className="px-6 py-4 font-medium text-gray-700">
                                  {(() => {
                                    const fee =
                                      enrollment.course?.tuitionFee ??
                                      enrollment.course?.fee?.amount ??
                                      null;
...
const CourseCard = ({ course }) => (
  <div className="p-4 rounded-xl border border-gray-200 bg-white hover:shadow-md transition-shadow group">
    ...
    <h4 className="font-bold text-gray-800 mb-1 line-clamp-1">
      {course.course?.name || course.class?.name}
    </h4>
    ...
    <div className="space-y-2 mt-4 pt-4 border-t border-gray-100">
      <div className="flex justify-between text-xs">
        ...
        <span className="font-medium">
          {course.course?.duration?.hours || 0} giờ
        </span>
      </div>
      <div className="flex justify-between text-xs">
        <span className="text-gray-500 flex items-center gap-1">
            ...
            <div className="grid grid-cols-2 gap-y-2 text-sm text-gray-600">
              ...
              <p>
                ...
                <span className="font-bold text-[var(--color-primary)]">
                  {(() => {
                    const fee =
                      selectedClassDetail.course?.tuitionFee ??
                      selectedClassDetail.course?.fee?.amount ??
                      null;
                    return fee !== null && fee !== undefined
                      ? formatCurrency(fee)
                      : "---";
