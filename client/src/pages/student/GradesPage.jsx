...
const GradesPage = () => {
  ...
  // Calculate letter grade from numeric score if not provided
  const getLetterGrade = (grade) => {
    if (grade && grade.letterGrade) return grade.letterGrade;

    // If no letterGrade but have totalScore, calculate it
